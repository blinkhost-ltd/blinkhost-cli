...
export interface ScaffoldModule { name: string; language: ModuleLanguage }
...
export interface Scaffold { manifest: BlinkHostManifest; files: Map<string, string> }
...
function commands(manager: PackageManager) {
  return {
...
function frontendFiles(name: string, framework: FrontendFramework): Map<string, string> {
...
function moduleFiles(module: ScaffoldModule): { entrypoint: string; files: Map<string, string> } {
